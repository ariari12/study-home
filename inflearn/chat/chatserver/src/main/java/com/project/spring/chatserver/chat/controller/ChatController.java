...
//    개인 채팅방 개설 또는 기존 roomId return
    ...
    public ResponseEntity<?> getOrCreatePrivateRoom(@RequestParam Long otherMemberId, Authentication auth) {
        Long roomId = chatService.getOrCreatePrivateRoom(otherMemberId, auth);
