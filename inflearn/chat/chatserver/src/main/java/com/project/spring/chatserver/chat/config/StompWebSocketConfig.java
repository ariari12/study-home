...
//                ws:// 가 아닌 http:// 엔드포인트를 사용할수있게 해주는 sockJS 라이브러리를 통한 요청을 허용하는 설정
                .withSockJS();
    }

    @Override
    public void configureMessageBroker(MessageBrokerRegistry registry) {
//        /publish/1 형태로 메세지 발행 설정
...
//    웹소켓 요청(connect, subscribe, disconnect) 등의 요청시에는 http 헤더 등 http 메시지를 넣어올 수 있고, 이를 interceptor를 통해
//    가로채 토큰등을 검증을 할 수 있음.
    @Override
